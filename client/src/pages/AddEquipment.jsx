...
function submitForm(e){
  ...
  //  trainer,
    ...
    if(name.length === 0 || address.length === 0 || email.length === 0 || sdate.length === 0 || mobile_no.length === 0 || price.length === 0 || nitem.length === 0 || paid.length === 0   ){
      ...
      axios.post("http://localhost:5000/api/equipments",userData)
      ...
      //  setPrograms("");
       // setTrainer("");
        swal({ text: "Successfully Added", icon: "success", button: "Okay!"}).then((res)=>{
          navigate(`/dash-view1`,{replace:true});
        })
                  ...
                  <section className="mb-4">
                    ...
                    <Col sm={10}>
                        ...
                        <Form.Group as={Row} className="mb-3" >
                          ...
                          <div className="form-floating mb-3">
                            <input className="form-control" id="amount" type="tel" placeholder="Amount" required maxLength="10" value={mobile_no} onChange={(e)=>setMobileNo(e.target.value)}/>
